    ...
    function populateTable(response) {
        ...
        response.forEach(function(kelas, index) {
            ...
            var indexListAtletButton = $('<button>')
                .addClass('focus:outline-none text-white bg-red-700 hover:bg-cyan-300 focus:ring-4 focus:ring-cyan-150 font-medium rounded-lg text-xs px-5 py-2.5 me-2 mb-2 dark:bg-cyan-300 dark:hover:bg-cyan-400 dark:focus:ring-cyan-150')
                .text('List Atlet')

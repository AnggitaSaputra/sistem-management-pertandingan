...
<div class="p-4 mt-2">
    <ul class="space-y-2 font-semibold">
        ...
        <li>
            <a href="{{ route('tim') }}" class="hover:text-gray-500 flex items-center p-2 rounded-lg group @if (Route::currentRouteName() == 'product') text-blue-700 @endif">
        ...
        <li>
            <a href="{{ route('atlet') }}" class="hover:text-gray-500 flex items-center p-2 rounded-lg group @if (Route::currentRouteName() == 'review') text-blue-700 @endif">
                <svg class="w-6 h-6 transition duration-75" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
        ...
        <li>
            <a href="{{ route('kelas') }}" class="hover:text-gray-500 flex items-center p-2 rounded-lg group @if (Route::currentRouteName() == 'review') text-blue-700 @endif">
        ...
        <li>
            <a href="{{ route('jadwal') }}" class="hover:text-gray-500 flex items-center p-2 rounded-lg group @if (Route::currentRouteName() == 'review') text-blue-700 @endif">
        ...
        <li>
            <a href="{{ route('pembayaran') }}" class="hover:text-gray-500 flex items-center p-2 rounded-lg group @if (Route::currentRouteName() == 'review') text-blue-700 @endif">
                <svg class="w-6 h-6 transition duration-75" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    ...
    <ul class="absolute bottom-5 left-0 space-y-2 font-semibold w-[250px] px-4 py-4">
        <li class="relative">
            <a href="#" class="hover:text-gray-500 flex items-center p-2 rounded-lg group" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
            ...
            <ul class="hidden text-gray-600 pt-1 w-48 rounded-lg" id="dropdown-example">
                ...
                <li><a href="{{ route('change.password', Auth::user()->id) }}" class="hover:bg-gray-300 py-2 px-4 block whitespace-no-wrap">Change Password</a></li>
            </ul>
        </li>                    
        <li>
            <li>

...
<div class="p-4 mt-2">
    <ul class="space-y-2 font-semibold">
        ...
        <li>
            <a href="{{ route('my.Tim') }}" class="hover:text-gray-500 flex items-center p-2 rounded-lg group @if (Route::currentRouteName() == 'tim') text-blue-700 @endif">
        ...
        <li>
            <a href="{{ route('my.Atlet') }}" class="hover:text-gray-500 flex items-center p-2 rounded-lg group @if (Route::currentRouteName() == 'tim') text-blue-700 @endif">
                <svg class="w-6 h-6 transition duration-75" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        <li>
            <a href="{{ route('my.Classes') }}" class="hover:text-gray-500 flex items-center p-2 rounded-lg group @if (Route::currentRouteName() == 'tim') text-blue-700 @endif">
                <svg class="w-6 h-6 transition duration-75" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
